...
const getIcon = (label) => {
  ...
  if (lowerLabel.includes('state')) return <MapPin className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('land use') || lowerLabel.includes('land ownership')) return <Map className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('route alignment') || lowerLabel.includes('length') || lowerLabel.includes('alignment')) return <Ruler className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('road crossing')) return <Map className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('railway')) return <Train className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('transmission') || lowerLabel.includes('infrastructure')) return <Zap className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('terrain') || lowerLabel.includes('mountainous') || lowerLabel.includes('hilly') || lowerLabel.includes('plain')) return <Mountain className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('tahasil')) return <MapPin className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('village')) return <MapPin className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('temperature')) return <Thermometer className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('major river') || lowerLabel.includes('river crossing')) return <Waves className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('nallahs') || lowerLabel.includes('drainage') || lowerLabel.includes('waterlogging')) return <Droplets className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('ground elevation') || lowerLabel.includes('elevation')) return <Navigation className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('trees between')) return <Trees className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('population')) return <MapPin className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('safety')) return <AlertCircle className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('risk')) return <AlertCircle className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('flood')) return <Waves className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('clay') || lowerLabel.includes('gravel') || lowerLabel.includes('sand') || lowerLabel.includes('silt') || lowerLabel.includes('soil')) return <Layers className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('density') || lowerLabel.includes('moisture') || lowerLabel.includes('liquid limit') || lowerLabel.includes('plastic') || lowerLabel.includes('ucs') || lowerLabel.includes('bearing') || lowerLabel.includes('gravity') || lowerLabel.includes('swelling')) return <Gauge className="w-3.5 h-3.5 text-white/90 shrink-0" />
  if (lowerLabel.includes('soil class')) return <Layers className="w-3.5 h-3.5 text-white/90 shrink-0" />
  return <Info className="w-3.5 h-3.5 text-white/90 shrink-0" />
}
...
function DataPanel({ label, value, header = false, icon, color = 'blue' }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-1">
        <div className="flex items-center justify-center gap-1.5 w-full">
          ...
          <span className="relative group/pin inline-flex" title={label}>
            <Pin className="w-3.5 h-3.5 text-white/80 hover:text-white cursor-help shrink-0" aria-hidden />
      ...
      <div
        className={`text-[16px] font-semibold mt-1 ${getValueColor(value)} transition-colors duration-200 flex items-center justify-center`}
        style={{ color: '#FFFFFF' }}
      >
        {value}
      </div>
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-transparent to-gray-900/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </div>
  )
}
